...
class DetectionActivity : AppCompatActivity() {
    ...
    // Инициализация активности, установка кнопок и проверка разрешений
    ...
    // Инициализация камеры и настроек для анализа изображений
    ...
    private fun initModel() {
        try {
            val modelPath = assetFilePath(this, "bes7.torchscript.ptl")
    ...
    // Проверка, предоставлены ли все необходимые разрешения
